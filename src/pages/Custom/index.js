        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.card}>
                    ...
                    <ToggleArea name="Clínica Médica" value={clinicaMedica} setValue={setClinicaMedica}/>
                    <ToggleArea name="Cirurgia Geral" value={cirurgiaGeral} setValue={setCirurgiaGeral}/>
                    <ToggleArea name="Pediatria" value={pediatria} setValue={setPediatria}/>
                    <ToggleArea name="Ginecologia e obstetrícia" value={ginecologia} setValue={setGinecologia}/>
                    <ToggleArea name="Medicina preventiva" value={preventiva} setValue={setPreventiva}/>
                </View>
            </LinearGradient>
            <Footer />
        </View>
